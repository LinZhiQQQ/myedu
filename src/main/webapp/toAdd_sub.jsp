...
%>
    ...
    <div style="margin-left: 20%; width: 50%; height: 50%; background:#d6ffdf;" align="center">
        ...
        <form method="post" name="add" action="${pageContext.request.contextPath}/edu/edu1_add_sub.action">
            <c:forEach items="${list}" var="item">

                <p><input type="checkbox" name="addId" value="${item.sub_id}"><c:out value="${item.sub_name}"></c:out></p>
            </c:forEach>

            <input type="submit" value="提交">

            <font color="red">${resultA}</font><br>
            <font color="green">${resultB}</font>
